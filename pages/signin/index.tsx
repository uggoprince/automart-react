...
import { invalidEmailErrorText, invalidPasswordErrorText } from "../../utilities/message";
                    ...
                    <div className=" w-full max-w-lg m-auto">
                        <Form method="POST" handleSubmit={handleSubmit}>
                            ...
                            <section className="grid gap-6">
                                <Input name="email" required={true} label={'Email'} type="email" error={errors.email != null} errorText={errors.email} />
                                <PasswordInput name="password" required={true} error={errors.password != null} errorText={errors.password} />
                                {/* <section className="form-block">
                                    <input type="submit" value="SIGN IN" />
                                </section> */}
                                <Button disable={loading} type="submit" handleClick={() => {}} text={submitButtonText} />
                            </section>
                        </Form>
                    </div>
                </section>
